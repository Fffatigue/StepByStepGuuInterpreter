...
import interpreter.util.FileUtils;
...
/**
 * MainFrame - interpreter.main application frame
...
public class MainFrame extends JFrame {
    ...
    protected void setStatusBar(JLabel statusBar) {
    ...
    public JToggleButton createToggleButton(JMenuItem item) {
    ...
    public JToggleButton createToggleButton(String menuPath) {
        JMenuItem item = (JMenuItem) getMenuElement( menuPath );
        if (item == null)
            throw new InvalidParameterException( "Menu path not found: " + menuPath );
        return createToggleButton( item );
    }
    ...
    public JToggleButton addToolBarToggleButton(String menuPath) {
        ...
        button = createToggleButton( menuPath );
        toolBar.add( button );
        return button;
    }
